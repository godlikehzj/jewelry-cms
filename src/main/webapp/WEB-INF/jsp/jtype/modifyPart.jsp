            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form id="modify_type" data-parsley-validate class="form-horizontal form-label-left" role="form">
                        ...
                        <input type="text" id="part_id" class="none" value="${part.id}">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">中文名称<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="name" required="required" value="${part.name}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="en-name" name="en-name" required="required" value="${part.enName}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div id="gender" class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                        下线:<input type="radio" class="flat" name="status" id="offline" value="0" <c:if test="${part.status == 0}">checked="checked"</c:if> />
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="button" class="btn btn-success" onclick="modifyPart()">修改</button>
