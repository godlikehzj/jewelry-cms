                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="title" required="required" value="${commodity.title}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="enTitle" name="enTitle" required="required" value="${commodity.enTitle}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="listTitle" name="listTitle" required="required" value="${commodity.listTitle}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="enlistTitle" name="enlistTitle" required="required" value="${commodity.enListTitle}" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <select class="select2_single form-control" tabindex="-1" id="type_select">
                                    <c:forEach var="type" items="${types}">
                                        <option value="${type.id}" <c:if test="${type.id == commodity.typeId}">selected="selected"</c:if>> ${type.name}</option>
                                    </c:forEach>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div id="status" class="btn-group" data-toggle="buttons">
                                    <label class="btn" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                        上线:<input type="radio" class="flat" name="status" id="online" value="1" <c:if test="${commodity.status == 1}">checked</c:if> />
                                    </label>
                                    <label class="btn" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                        下线:<input type="radio" class="flat" name="status" id="offline" value="0" <c:if test="${commodity.status == 0}">checked</c:if> />
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="button" onclick="commodity.getList()" class="btn createbtn btn-primary">Cancel</button>
                                <button type="button" onclick="submitCommodity()" class="btn createbtn btn-success">Submit</button>
                            </div>
                        </div>
...
<script>
    ...
    $("#detail-pic").fileinput({
        ...
        initialPreviewConfig:detail_cfg
    });
